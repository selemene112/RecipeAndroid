/* This Code For Edit My Recipe
this code same structur with add Recipe on organisme
 */
...
import {editMenu} from '../../../Redux/Actions/Recipe/EditMenu';
...
function EditMyRecipe() {
  ...
  const {isLoading} = useSelector(state => state.editMenu);
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.TitlePage}>Edit My Recipe</Text>
      <TextInput
      ...
      />
      {selectedImage && (
        <Image source={{uri: selectedImage?.uri}} style={styles.ImageRecipe} />
      )}
      ...
      <TouchableOpacity style={styles.button} onPress={uploadRecipe}>
        <Text style={styles.buttonText}>Edit My Menu </Text>
      </TouchableOpacity>
    </View>
  );
}
